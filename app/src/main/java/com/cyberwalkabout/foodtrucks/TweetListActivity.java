...
import com.cyberwalkabout.foodtrucks.dummy.DummyContent;
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(MapFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(MapFragment.ARG_ITEM_ID, holder.mItem.id);
