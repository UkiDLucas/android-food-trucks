...
import com.uki.common.util.FileUtils;
import com.uki.common.util.IOUtils;
...
public class DownloadFile extends AsyncTask<String, Integer, String>
{
	...
	public static File toDownloadDir(String url)
	{
		return new File(new File(Environment.getExternalStorageDirectory() + "/Download"), Uri.parse(url).getLastPathSegment());
	}
	...
	protected void onPreExecute()
	{
		...
		String mimeType = FileUtils.getMimeType(outFile);
