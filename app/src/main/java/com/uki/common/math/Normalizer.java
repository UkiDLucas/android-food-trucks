...
public class Normalizer {
	...
	public static double normalize(double dataHigh, double dataLow, double normalizedHigh, double normalizedLow, double x) {
	...
	public static void main(String[] args) {
		...
		Normalizer norm = new Normalizer(0, 75, 0.86, 0.93);
