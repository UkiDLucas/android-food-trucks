...
import com.uki.twitter.HttpHelper;
...
public class TwitterOAuthActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		SharedPreferences prefs = getSharedPreferences(TwitterServices.PREFS_NAME, MODE_PRIVATE);
		mCallbackUrl = prefs.getString(TwitterServices.TWITTER_CALLBACK_URL, "");
		mConsumerKey = prefs.getString(TwitterServices.TWITTER_CONSUMER_KEY, "");
		mConsumerSecret = prefs.getString(TwitterServices.TWITTER_CONSUMER_SECRET, "");
        ...
        mOAuthWebView.setWebChromeClient(new WebChromeClient() {
            public void onProgressChanged(WebView view, int progress) {
                ...
                if (progress == 100)
                    TwitterOAuthActivity.this.setTitle(TwitterServices.appName);
            }
        });
        ...
        mTwitterConsumer = new DefaultOAuthConsumer(mConsumerKey, mConsumerSecret);
        mTwitterProvider = new DefaultOAuthProvider("http://api.twitter.com/oauth/request_token",
    ...
    private final class RetriveAccessTokenInBackground extends Thread {
        ...
        public void run() {
            ...
            TwitterServices.twitterOAuthHandler.handle(mTwitterConsumer.getToken(),
